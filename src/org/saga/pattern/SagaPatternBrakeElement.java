...
public class SagaPatternBrakeElement extends SagaPatternElement {
	 ...
	 */
	public SagaPatternBrakeElement(int xOffset, int yOffset, int zOffset, Short minimumLevel, Short maximumLevel) {
	 ...
	 * @param zOffset z offset
	 */
	public SagaPatternBrakeElement(int xOffset, int yOffset, int zOffset) {
