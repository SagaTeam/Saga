...
public class ProfessionConfiguration {
	...
	private boolean complete() {
		...
		if(professionDefinitions == null){
			professionDefinitions = new ArrayList<ProfessionDefinition>();
		...
		for (ProfessionDefinition definition : professionDefinitions) {
			...
			String[] abilityNames = definition.getAbilityNames();
		...
		professionDefinitionPool = new Hashtable<String, ProfessionDefinition>();
		for (ProfessionDefinition definition : professionDefinitions) {
